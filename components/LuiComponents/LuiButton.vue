    ...
    disableStyles: {
      ...
      validator(value) {
        return (
          ...
          ['hover', 'focus', 'disable', 'underline', ''].some((r) =>
            value.includes(r)
          )
        )
      },
  ...
  setup(props, context) {
    const computedClasses = computed(() => {
      const classes = {
        ...
        borderWidth:
          props.type === 'outline' || props.type === 'default' ? 'border' : '',
        borderStyle:
        ...
        borderBottom:
          (typeof props.disableStyles === 'boolean' &&
            props.disableStyles === true) ||
          (Array.isArray(props.disableStyles) &&
            props.disableStyles.includes('underline'))
            ? ''
        ...
        display:
          props.prepend !== 'none' || props.icon !== 'none' ? 'flex' : '',
        justifyContent:
          props.prepend !== 'none' || props.icon !== 'none'
            ? 'justify-center'
            : '',
        alignItems:
          props.prepend !== 'none' || props.icon !== 'none'
